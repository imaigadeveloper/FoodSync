...
<div class="contenedor-sitio">
    ...
    <main class="contenido">
        <section class="panel-principal">
            <h1 class="titulo-menu">Menú de platillos</h1>

            <% 
                if (rolLogueado != null && rolLogueado.equals("Supervisor")) { 
            %>
            ...
            try{
                ...
                ps = con.prepareStatement("SELECT * FROM Platillos WHERE estado='Disponible'");
                rs = ps.executeQuery();

                while(rs.next()){
            %>
                <div class="card-platillo">
                    <img src="Platillos/<%= rs.getString("ruta_imagen") %>" alt="<%= rs.getString("nombre") %>">
            ...
            <%
                ...
                out.println("<h2>Error al cargar el catálogo: " + e.getMessage() + "</h2>");
            }finally{
                try{
                    if(rs!=null) rs.close();
                    if(ps!=null) ps.close();
